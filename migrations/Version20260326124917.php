 ...
 */
final class Version20260326124917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD is_paymnent_completed TINYINT NOT NULL, ADD is_payment_completed TINYINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP is_paymnent_completed, DROP is_payment_completed');
